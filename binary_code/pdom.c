...
//     if (thread_id < dim_order[1])
//     {
//         for (int q = 0; q < dim_order[1]; q++)
//         {
//             // tb[thread_id*dim_order[1] + q] = 0;

//             for (int i = 0; i < blockno; i++)
//             {
//                 tb[thread_id * dim_order[1] + q] += stx[thread_id * blockno + i] * sty[q * blockno + i];
//             }
//             tb[thread_id * dim_order[1] + q] /= (r[thread_id] * r[q]);
//         }
//     }
// }